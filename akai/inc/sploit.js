...
-------------------------------------------------------------------------------
        ...
        */
        ...
        var caller = get_caller(tmpmem, eleobj, vtidx, fkvtable);
        ...
        var res = sceKernelGetModuleList();
        ...
        for(i=0;i<num_loaded*4;i+=4){
            ...
            var mod_info_a = result[1];
            //do_read(aspace,mod_info_a,440);
            //logdbg("----");
            //do_read(aspace,mod_info_a+0x154,0x18*4);
            var segment_info_a = mod_info_a+0x154;
